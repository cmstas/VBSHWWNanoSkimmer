...
if __name__ == "__main__":
    ...
    for sample in samples:
        task = CondorTask(
                ...
                tag = tag,
                condor_submit_params = {"sites": ",".join([ x for x in list(good_sites) if x != "T2_US_UCSD" ] )},
                # condor_submit_params = {"sites": "T2_US_UCSD,T2_US_Purdue", "classads": [ ["metis_extraargs", "fetch_nano"] ]},
